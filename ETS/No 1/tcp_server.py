...
alldata = dict()
alldata['1']=dict(nomor=1, nama="v", posisi="main vocal")
alldata['2']=dict(nomor=2, nama="jungkook", posisi="main vocal")
alldata['3']=dict(nomor=3, nama="jin", posisi="main vocal")
alldata['4']=dict(nomor=4, nama="jimin", posisi="main vocal")
alldata['5']=dict(nomor=5, nama="Kim Taehyung", posisi="main vocal")
alldata['6']=dict(nomor=6, nama="Jeon Jung Kook", posisi="main vocal")
alldata['7']=dict(nomor=7, nama="Kim Seokjin", posisi="main vocal")
alldata['8']=dict(nomor=8, nama="Park Jimin", posisi="main vocal")
alldata['9']=dict(nomor=9, nama="RM", posisi="main rapper")
alldata['10']=dict(nomor=10, nama="Suga", posisi="main rapper")
alldata['11']=dict(nomor=11, nama="Agustd", posisi="main rapper")
alldata['12']=dict(nomor=12, nama="Min Yoongi", posisi="main rapper")
alldata['13']=dict(nomor=13, nama="J-Hope", posisi="main dancer")
alldata['14']=dict(nomor=14, nama="Jung Hoseok", posisi="main dancer")
alldata['15']=dict(nomor=15, nama="Kim Namjoon", posisi="main rapper")
alldata['16']=dict(nomor=16, nama="Namjoon", posisi="main rapper")
alldata['17']=dict(nomor=17, nama="Taehyung", posisi="main vocal")
alldata['18']=dict(nomor=18, nama="Seokjin", posisi="main vocal")
alldata['19']=dict(nomor=19, nama="Hoseok", posisi="main dancer")
alldata['20']=dict(nomor=20, nama="Yoongi", posisi="main rapper")
